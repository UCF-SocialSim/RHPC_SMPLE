...
YouTubeFeedExplanation::YouTubeFeedExplanation(): Explanation(), randomlySelected(false),
...
YouTubeFeedExplanation::YouTubeFeedExplanation(const YouTubeFeedExplanation& orig): Explanation(),randomlySelected(orig.randomlySelected),
...
YouTubeFeedExplanation::~YouTubeFeedExplanation(){ }

std::string YouTubeFeedExplanation::getRow(){
    std::stringstream s;
