...
GitHubFeedExplanation::GitHubFeedExplanation():
        Explanation(),
        randomlySelected(false),
        userIsFollowing(false),
        userIsContributing(false),
        proposedBecauseUserLikesSimilar(false),
        userSearch(false),
        fitnessValue(0),
        distance(0){ }

GitHubFeedExplanation::GitHubFeedExplanation(const GitHubFeedExplanation& orig):
		Explanation(),
		randomlySelected(orig.randomlySelected),
	    userIsFollowing(orig.userIsFollowing),
		userIsContributing(orig.userIsContributing),
	    proposedBecauseUserLikesSimilar(orig.proposedBecauseUserLikesSimilar),
		userSearch(orig.userSearch),
	    fitnessValue(orig.fitnessValue),
	    distance(orig.distance){ }

GitHubFeedExplanation::~GitHubFeedExplanation(){ }

std::string GitHubFeedExplanation::getRow(){
	std::stringstream s;
...
// void GitHubFeedExplanation::add(GitHubFeedExplanation& other){
